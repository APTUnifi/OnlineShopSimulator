...
public class ShopViewPanel extends JPanel implements ShopView {
	...
	public ShopViewPanel() {
		...
		add(itemListShop);
		itemListShop.addListSelectionListener(e -> btnAdd.setEnabled(itemListShop.getSelectedIndex() != -1));
	...
	public void errorLogItem(String error, String item) {
		SwingUtilities.invokeLater(() -> lblErrorMessageLabel.setText(error + ": " + item));
	}
