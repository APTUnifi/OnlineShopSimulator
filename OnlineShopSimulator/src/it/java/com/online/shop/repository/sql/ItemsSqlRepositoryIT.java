...
public class ItemsSqlRepositoryIT {
	...
	public void testRemoveCartFromTableCarts() {
		...
		repository.removeCart("testCart", LocalDate.now().toString());
	...
	public void testRemoveCartIfAlsoAllItemsInItAreDropped() {
		...
		repository.removeCart(cartToRemove.getLabel(), cartToRemove.getDate());
	...
	public void testFindCart() {
		...
		assertThat(repository.findCart(cartToFind.getLabel(), cartToFind.getDate())).isEqualTo(new Cart(Arrays.asList(new Item("1", "test", 1)), "testCart"));
	}
	
	@Test
	public void testStoreCartSavingNewCartInCartsTable() {
		
		//TODO review by all team
